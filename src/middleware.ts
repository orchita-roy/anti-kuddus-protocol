...
export const config={matcher:["/dashboard/:path*","/complaints/:path*","/seat-planner/:path*","/syllabus/:path*","/ledger/:path*","/sos/:path*","/fact-check/:path*","/captain/:path*","/teacher/:path*","/admin/:path*"]};
